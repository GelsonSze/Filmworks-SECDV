...
app.delete('/deletecart/:cartItemID', credentials_controller.checkAuth, cart_controller.deleteMovieFromCart)
...
app.post(`/delete-review/:reviewID`, credentials_controller.checkAuth, flagProfileUpload, upload.single("file"), multerError, movie_controller.deleteReview)

app.post(`/edit-review/:reviewID`, credentials_controller.checkAuth, flagProfileUpload, upload.single("file"), multerError, movie_controller.editReview)
